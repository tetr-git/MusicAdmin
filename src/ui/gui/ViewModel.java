...
public class ViewModel {
    ...
    @FXML private TableView<MediaTableWrapper> mediaTable = new TableView<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableAddress = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableInstance = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableMediaType = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableMediaUploader = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableTags = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableAccessCount = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableBitrate = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableMediaLength = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableSamplingRate = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableResolution = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableHolder = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableInteractiveType = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableMediaUploadDate = new TableColumn<>();
    @FXML private TableColumn<MediaTableWrapper, String> mediaTableSize = new TableColumn<>();

    @FXML private TableView<UploaderWithAmountTableWrapper> uploaderTable = new TableView<>();
    @FXML private TableColumn<UploaderWithAmountTableWrapper, String> uploaderColumn = new TableColumn<>();
    @FXML private TableColumn<UploaderWithAmountTableWrapper, String> uploaderAmountColumn = new TableColumn<>();
    @FXML private TableColumn<UploaderWithAmountTableWrapper, String> uploaderInstance = new TableColumn<>();

    @FXML private TableView<TagTableWrapper> tagsTable = new TableView<>();
    @FXML private TableColumn<TagTableWrapper, String> tagColumn = new TableColumn<>();
    @FXML private TableColumn<TagTableWrapper, String> tagInstance = new TableColumn<>();
